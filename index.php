...
?>
	...
	<div class=" session-green">
		<div class="container">

			<div class="carr-home-02">
			...
			<div class="carr-home-03">
				<div class="control"></div>
				<div class="wrap">
					<div class="wrap-custom">
						<img src="public/assets/img/home/img1.png" width="415px" height="270" />
						<div>
							<h4>Produtos</h4>
			...
			<h3 class="flutuant-title">Produtos e Serviços</h3>


		</div>
		<!--container-->
		<div class="carr-home-04">
			<div class="mini-wrap-control">
				<!-- <div class="control"></div> -->
			</div>
			<div class="wrap">
				<div>
	...
	</div> <!-- close session blog -->

	<div class="sesseion-arr">
		<div class="container">
			<p class="text-arr">
				<span>A RR Donnelley</span>
			</p>
			<p class="text-donnelley">é líder global em soluções gráficas, listada na Fortune como uma das 500 maiores
				corporações da América.</p>
			<p class="text-donnelley">Em 2010 contabilizou uma receita de mais de 10 bilhões de dólares.
				A corporação é hoje o maior diretório de impressões do mundo, atendendo os maiores mercados dos EUA; é também
	...
	<div class="session-conecta">
		<div class="container">
			<p class="text-conecta" style="padding-top: 2.5em;">CONECTAMOS SUA MARCA AO SEU</p>
